...
parameters_low = rio.open_rasterio(
    "data/results_parameters_optim_low_resolution.tif", band_as_variable=True
)
parameters_low
...
lst_high = rio.open_rasterio("data/cube_LST_median.tif", band_as_variable=True)

# lst_high = lst_high.rename(new_name_or_name_dict={"x": "longitude", "y": "latitude"})


# regridder = xe.Regridder(parameters_low, lst_high, method="bilinear")
...
parameters_high_da = parameters_high.to_dataarray(name="band")

# parameters_high = parameters_low.rio.reproject_match(lst_high)

# Saving the resample raster

parameters_high_da.rio.to_raster("data/results_paramaters_high_resolution.tif")
