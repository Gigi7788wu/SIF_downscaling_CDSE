...
nirv_1km_local = rio.open_rasterio(
    "data/cube_nirv_1km_mask.tif", band_as_variable=False
)
print(nirv_1km_local)
# creating a mask band for interpolation

lst_high = nirv_1km_local.rename(
    new_name_or_name_dict={"x": "longitude", "y": "latitude"}
)
...
parameters_high = parameters_high.where(~np.isnan(nirv_1km_local))
