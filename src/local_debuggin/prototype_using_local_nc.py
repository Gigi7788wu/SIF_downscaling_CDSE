...
s3_syn_clouds = xr.open_dataset("data/sentinel_3_cloud.nc")

print(s3_syn_clouds)
s3_syn_clouds["CLOUD_flags"].isel(t=0).plot()

s3_syn_clouds["CLOUD_flags"].attrs
...
parameters_high = rio.open_rasterio("data/results_paramaters_high_resolution.tif")
